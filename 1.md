...
```bash
conda create -n mxr_kgllm python=3.10 mkl=2024.2 -y
...
python train_test.py --large_language_model_name meta-llama/Llama-3.2-1B-Instruct --sentence_transformer_name sentence-transformers/all-MiniLM-L6-v2 --debug False --device cuda:0 --dataset_name synthetic.json --tokenizer_padding_side left --num_epoch 10 --batch_size 10 --stopper_patience 3 --optimizer_learning_rate 0.0001 --optimizer_weight_decay 0.0001 --seed 1 --separate_query_head True --kb_scale_factor None --kb_layer_frequency 3 --save_model True
