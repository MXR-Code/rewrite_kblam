...
python train_test.py --device cuda:5 --large_language_model_name meta-llama/Llama-3.2-1B-Instruct --sentence_transformer_name sentence-transformers/all-MiniLM-L6-v2 --debug False --dataset_name synthetic.json --tokenizer_padding_side left --num_epoch 10 --batch_size 10 --stopper_patience 1000 --optimizer_learning_rate 0.0001 --optimizer_weight_decay 0.0001 --seed 1 --separate_query_head True --kb_layer_frequency 3 --save_model True --huggingface_accesstoken 

CUDA_VISIBLE_DEVICES=5 nohup \
python train_test.py --device cuda:0 --large_language_model_name meta-llama/Llama-3.2-1B-Instruct --sentence_transformer_name sentence-transformers/all-MiniLM-L6-v2 --debug False --dataset_name synthetic.json --tokenizer_padding_side left --num_epoch 10 --batch_size 10 --stopper_patience 1000 --optimizer_learning_rate 0.0001 --optimizer_weight_decay 0.0001 --seed 1 --separate_query_head True --kb_layer_frequency 3 --save_model True --huggingface_accesstoken \
> output.log 2>&1 &
